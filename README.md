...
- 🌱 **Python**: Entrada e Saída de Dados, Teste Unitário (pytest), POO, Introdução Padrões(Iterator, Strategy, Adapter,Decorator, Observer e Factory), Raspagem de Dados, COmplexidade de Algoritmo e Recursividade. 
<div>
SOBRE:
